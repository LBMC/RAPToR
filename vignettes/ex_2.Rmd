...
This shows how inter-individual variation in developmental speed makes it difficult to profile high-temporal-resolution time series.

Furthermore, the temporal resolution difference between the reference and validation data demonstrates the effectiveness of gene expression interpolation.
