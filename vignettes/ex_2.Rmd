...
```{r ex2_qnorm_log, class.source='fold-show', message=FALSE, warning=FALSE}
library(RAPToR)
library(limma)
...
```{r ex2_mf_c3, class.source='fold-show'}
...
```{r ex2_vd_c3, class.source='fold-show', warning=FALSE, warning=FALSE, results='hide'}
