...
As any R model, GEIMs have a `predict()` function (called internally by `make_ref()`) which can be used to manually get predictions either in component space or at the gene level. 
