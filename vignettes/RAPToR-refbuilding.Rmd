...
cv_ds1 <- ge_imCV(X = ds1$g, p = ds1$p, formula_list = flist,
...
cv_ds1k <- ge_imCV(X = ds1$g, p = ds1$p, formula_list = flistk,
                   cv.n = 20, nc = nc, nb.cores = 3)
