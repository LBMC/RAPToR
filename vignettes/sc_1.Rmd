...
In the grapĥic below, we plot the correlation score between all sample pairs against their estimated age difference. 
...
We can also observe this through correlation heatmaps ordered by strain or estimated age

<div style = "display:block">
<div style="width:49%; float:left">
```{r sc1_hm_strain, echo = F, fig.height=5, fig.width=6}
show_fig(expr = {
  # ord1 <- order(dslehrbach2012$p$strain)
  
  # heatmap(cc[ord1, ord1], Colv = NA, Rowv = NA, scale = "none", keep.dendro = F, margins = c(2,5),
  #         RowSideColors = transp(as.numeric(dslehrbach2012$p$strain[ord1])), labRow = "", labCol = "",
  #         main = "Ordered by strain")
...
get_ssq <- function(dsgn, X){
  ...
  vex <- data.frame(age=vs[,1], strain=vs[,2]-vs[,1], age.strain = vs[,3]-vs[,2], 
