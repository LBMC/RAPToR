...
age_dif <- ae_dslb$age.estimates[dslehrbach2012$p$strain=="wt",1] - ae_dslb$age.estimates[dslehrbach2012$p$strain!="wt",1]
reps <- dslehrbach2012$p$rep[dslehrbach2012$p$strain=="wt"]

summary(lm(age_dif~reps))$coefficients
#>
#>               Estimate Std. Error    t value   Pr(>|t|)
#> (Intercept) -2.2168512  0.7784027 -2.8479492 0.01915315 *
#> reps2       -0.9360038  1.1008276 -0.8502729 0.41721906
#> reps3        3.4976985  1.1008276  3.1773355 0.01123277 *
```
```{r sc1_stat_batch_plot, eval=gen_figs, fig.width=4, fig.height=5, echo=F, out.width="60%"}
show_fig(expr = {
plot(age_dif~reps, 
     ylab="Estimated age difference between wt and mut samples (h)", 
