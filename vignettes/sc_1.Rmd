...
Using identical DE models with either chronological age or RAPToR age estimates as covariates, we can determine which of the two is the best predictor and thus gives more power to detect differentatial expression. 
...
```{r sc1_ae_lb, eval=gen_figs,  class.source = 'fold-show', warning=FALSE}
# load reference
...
```{r do_dge, eval = gen_figs, results='hide', class.source='fold-show'}
