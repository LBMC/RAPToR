...
References correspond to pre-processed gene expression datasets, and their optimal interpolation parameters.
...
The data is used for building the plot in `.plot_refs()` 