...
Using RAPToR, we can capture tissue-specific age by restricting the geneset used for staging the tissue of interest.
...
We can use PCA or ICA components to look at the ynamics of the dataset on a global scale.
...
```{r sc3_ae_sg_ica, echo = F, fig.height=6, fig.width=15}
show_fig(expr = {
