...
For example, when large developmental timecourse datasets are produced, the samples are systematically re-ordered post-profiling.
...
<center>
![tool_overview](../inst/cdoc/tool_overview.png){width=90%}
</center>
