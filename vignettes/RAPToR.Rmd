...
To determine if an existing reference in a data-package cover the appropriate development for your samples, use `list_refs()` like above, or the `plot_refs()` function which shows the references available in the data-package (in this case, `wormRef`) along with landmark developmental stages. 
