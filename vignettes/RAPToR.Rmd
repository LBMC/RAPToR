...
Please cite our preprint (@bulteau2021raptor) if you use RAPToR in your research:
...
In the interest of lightening the computational load (each timepoint of the reference is compared to the samples) you can choose smaller values, but aim over 500 for optimal results.
...
These correlation profiles can be plotted with `plot_cor.ae()`
...
You can also specify if you want the predictions in component space or as the full gene expression matrix.
