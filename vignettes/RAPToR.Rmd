...
The output of `ae()` is an `ae` object with various elements, including age estimate and confidence intervals from booststrapping (age estimate on random gene subsets).
