...
```{r fig_tool_overview, echo=F}
knitr::include_graphics(file.path(figpath,"tool_overview.jpg"))
```

# What type of data can be used ?

`RAPToR` can stage samples from any genome-wide gene expression profiling method  : RNA-seq (preferably TPM), MicroArray...
...
To provide a quick and easy way to predict the age of samples, we pre-built several references for commonly used organisms from available data in the literature.
