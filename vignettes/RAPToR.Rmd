...
The `ae` object also keeps record of the correlation scores of samples against the full reference (also for bootstrap estimates). 
...
## About the models
The strategy we put forward for predicting on such a large scale of output variables (genes), is to interpolate in a dimensionally reduced space. 
